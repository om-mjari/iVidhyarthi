    ...
    const certificates = await Certificate.insertMany([
      {
        Course_Id: 'COURSE_002',
        Student_Id: 'STU_001',
        Certificate_Url: 'https://example.com/certificates/cert_stu001_course002.pdf',
        Grade: 'A',
        Percentage: 92,
        Status: 'Active'
      }
    ...
    const feedbacks = await Feedback.insertMany([
      {
        ...
        Student_Id: 'STU_001',
        Rating: 5,
        Comment: 'Excellent course! The instructor explains concepts very clearly and the assignments are practical.',
        Status: 'Approved',
        Helpful_Count: 12
      },
      {
        ...
        Student_Id: 'STU_002',
        Rating: 4,
        Comment: 'Great content and well-structured lectures. Would love more hands-on projects.',
        Status: 'Approved',
        Helpful_Count: 8
      },
      {
        ...
        Student_Id: 'STU_001',
        Rating: 5,
        Comment: 'Best course I have taken! Highly recommended for anyone interested in this topic.',
        Status: 'Pending',
        Helpful_Count: 3
      }
    ]);
